...
public class AppRoleService {
     ...
     * @return
     */
    public boolean updateRoleProperties(AppRoleUpdate roleUpdate) {
        ...
        Update update = new Update()
                .set(AppRole.FIELD_PROPERTIES, properties)
                .set(AppRole.FIELD_MODEL_ID, roleUpdate.getModelId());

        mongoTemplate.updateMulti(query, update, MongoCollection.APP_ROLE);
        return true;
    }
     ...
     * @return
     */
    public boolean grantResource(String roleId, List<String> resourceIds) {
        // 检查有效的资源ID，排除已经无效的
